...
INSERT INTO `admin`(`admin_id`, `user`, `pass`, `first_name`, `last_name`) VALUES (1,'admin@gmail.com','admin','Darlene','Graterol');
...
INSERT INTO `loan` (`loan_id`, `cat_id`, `loan_come_from`, `loan_amount`, `loan_interest`, `payment_term`, `total_payment_with_intereset`, `emi_per_month`, `payment_schedule`, `due_date`) VALUES
(2, '301', 'Credit cards', '1000', '10', '2', '1200', '50', '2016-09-01', '2016-09-04'),
(3, '302', 'cars', '10000', '10', '3', '13000', '361.1111111111111', '2016-08-25', '2016-08-26');
--
...
--
INSERT INTO `goal` (`goal_id`, `name`, `description`, `goal_amount`, `cat_id`, `goal_date`) VALUES
(1, 'vacation', 'fun', 2000, 302, '2016-08-11');
...
CREATE TABLE IF NOT EXISTS `payment_history_room` (
...
INSERT INTO `payment_history_room` (`room_id`, `name`, `budget`, `room_date`) VALUES ('1', 'kitchen', '3000', '2021-03-09');
--
